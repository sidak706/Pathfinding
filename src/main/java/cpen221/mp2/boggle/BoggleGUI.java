...
import cpen221.mp2.utils.StdRandom;
...
public class BoggleGUI extends JFrame {
    ...
    public BoggleGUI(int rows, int cols) {
        ...
        In in1 = new In(new File("data/boggle/dictionary-shakespeare.txt"));
        ...
        In in2 = new In(new File("data/boggle/dictionary-nursery.txt"));
        ...
        In in3 = new In(new File("data/boggle/dictionary-common.txt"));
        ...
        // dictionary
        In in = new In(new File("data/boggle/dictionary-yawl.txt"));
